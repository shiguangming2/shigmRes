...
public class POIUtils {
    public static ResponseEntity<byte[]> exportData2Excels(List<Employee> list) {
        //1.创建文档
        ...
        information.setManager("shigm");
        information.setCompany("org.shigm");
        //获取文档摘要信息
        SummaryInformation summaryInformation = workbook.getSummaryInformation();
        summaryInformation.setTitle("员工信息");
        summaryInformation.setAuthor("shigm");
        summaryInformation.setComments("本文档有java大神shigm编写");
        ...
        return new ResponseEntity<byte[]>(arrayOutputStream.toByteArray(), headers, HttpStatus.CREATED);
    }

    public static List<Employee> HandlerExcelData(MultipartFile file, List<Politicsstatus> allPolicies, List<Position> allPositions, List<Nation> allNations, List<Department> allDepts, List<JobLevel> allJobLevels) {
                            ...
                            case STRING:
                                ...
                                switch (k) {
                                    ...
                                    case 8:
                                        ...
                                        break;
                                    case 9:
                                        int politicstatusIndex = allPolicies.indexOf(new Politicsstatus(cellValue));
                                        employee.setPoliticId(allPolicies.get(politicstatusIndex).getId());
                                        break;
                                    case 10:
                                    ...
                                    case 11:
                                        ...
                                        break;
                                    case 12:
                                        int departmentIndex = allDepts.indexOf(new Department(cellValue));
                                        employee.setDepartmentId(allDepts.get(departmentIndex).getId());
                                        break;
                                    case 13:
